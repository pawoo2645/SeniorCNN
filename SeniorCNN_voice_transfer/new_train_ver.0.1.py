...
CONTENT_FILENAME = basepath + "mz09_t09_s02.wav"
...
gen_audio_C = basepath +"191102_mz09+mv13_t09_s02.wav"
...
CONTENT_FILENAME = basepath + "191102_mz09+mv13_t09_s02.wav"
#J - same style name
# STYLE_FILENAME = basepath + "mv13_t09_s02.wav"
...
gen_audio_C = basepath +"4th_191102_mz09+mv13.wav"
spectrum2wav(gen_spectrum, sr, gen_audio_C)

plt.figure()
plt.plot(all_losses)
plt.savefig('4th loss_curve.png')

plt.figure(figsize=(5, 5))
# we then use the 2nd column.
plt.subplot(1, 1, 1)
plt.title(basepath +"4th Content Spectrum")
plt.imsave(basepath +'4th Content_Spectrum.png', a_content[:400, :])

plt.figure(figsize=(5, 5))
# we then use the 2nd column.
plt.subplot(1, 1, 1)
plt.title(basepath +"4th Style Spectrum")
plt.imsave(basepath +'4th Style_Spectrum.png', a_style[:400, :])

plt.figure(figsize=(5, 5))
# we then use the 2nd column.
plt.subplot(1, 1, 1)
plt.title(basepath +"4th CNN Voice Transfer Result")
plt.imsave(basepath +'4th Gen_Spectrum.png', gen_spectrum[:400, :])
