...
while line_Con and line_Sty and line_Res:
    ...
    # J
    plt.imsave(line_Res+'Gen_Spectrum.png', gen_spectrum[:400, :])

    input = Variable(input.cuda())
    print(input)

    line_Con = listCon.readline()
    line_Sty = listSty.readline()
    line_Res = listRes.readline()
